...
[assembly: Dependency(typeof(NFCBL.Droid.NFCServices.NFCImplementation))]
namespace NFCBL.Droid.NFCServices
{
	...
	public class NFCImplementation : INFC
	{
		...
		/// <summary>
		/// Checks If the NFC tag is connected or not 
		/// </summary>
		...
		public bool IsConnectedNFC
		{
			get
			{
				if (_currentTag == null)
					return false;
				else if (!ndef?.IsConnected ?? true )
                {
		...
		public void StartMessagePublished()
		{
			var nTag = GetTagInfo(_currentTag);
        ...
        public event EventHandler TagConnectedEventHandler;
        public event EventHandler TagDisconnectedEventHandler;
