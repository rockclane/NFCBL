...
namespace NFCBL.Droid.NFCServices
{
	...
	public static partial class CrossNFC
	{
		...
		public static void OnNewIntent(Intent intent) => ((NFCImplementation)NFCBL.Services.CrossNFC.Current).HandleNewIntent(intent);

		/// <summary>
		/// Overrides Activity.OnResume()
		/// </summary>
		public static void OnResume() => ((NFCImplementation)NFCBL.Services.CrossNFC.Current).HandleOnResume();
