...
{
        using global::Plugin.BluetoothClassic.Abstractions;
        using System;
        ...
        /// </summary>
        public static class RetryBluetoothConnectionService
        {
            ...
            public static async Task<bool> RetryConnectAsyncSer(this IBluetoothConnection bluetoothConnection,
                int retriesCount = 3)
            {
